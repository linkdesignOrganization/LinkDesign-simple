...
/** Trozo de la intro: texto plano o un enlace interno (por ejemplo al hub de software CR). */
...
@Component({
  ...
  styles: `
    ...
    /* Enlace dentro de la intro (al hub de software CR): sin botón, solo subrayado fino. */
    .vc-intro__link {
      color: var(--ink);
