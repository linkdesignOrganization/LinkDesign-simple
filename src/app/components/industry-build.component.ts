              ...
              <article class="ibuild-card ibuild-anim">
                <div class="ibuild-card__top">
                  <span class="ibuild-card__icon" aria-hidden="true">
                    @switch (item.kind) {
                      @case ('internal') {
                        <svg lucideMonitorCog [size]="28" [strokeWidth]="1"></svg>
                      }
                      @case ('portal') {
                        <svg lucideUsers [size]="28" [strokeWidth]="1"></svg>
                      }
                      @case ('mobile') {
                        <svg lucideSmartphone [size]="28" [strokeWidth]="1"></svg>
                      }
                      @case ('billing') {
                        <svg lucideReceipt [size]="28" [strokeWidth]="1"></svg>
                      }
                      @case ('web') {
                        <svg lucideGlobe [size]="28" [strokeWidth]="1"></svg>
                      }
                      @case ('scheduling') {
                        <svg lucideCalendarClock [size]="28" [strokeWidth]="1"></svg>
                      }
                      @case ('records') {
                        <svg lucideClipboardList [size]="28" [strokeWidth]="1"></svg>
                      }
                      @case ('crm') {
                        <svg lucideGitCompareArrows [size]="28" [strokeWidth]="1"></svg>
                      }
                    }
                  </span>
