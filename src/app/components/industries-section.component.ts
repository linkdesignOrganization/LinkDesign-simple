          ...
          <article class="ind-card ind-reveal" [style.--i]="i">
            <header class="ind-card__top">
              <span class="ind-card__icon" aria-hidden="true">
                @switch (item.icon) {
                  @case ('factory') {
                    <svg lucideFactory [size]="28" [strokeWidth]="1"></svg>
                  }
                  @case ('truck') {
                    <svg lucideTruck [size]="28" [strokeWidth]="1"></svg>
                  }
                  @case ('health') {
                    <svg lucideHeartPulse [size]="28" [strokeWidth]="1"></svg>
                  }
                  @case ('briefcase') {
                    <svg lucideBriefcase [size]="28" [strokeWidth]="1"></svg>
                  }
                  @case ('wrench') {
                    <svg lucideWrench [size]="28" [strokeWidth]="1"></svg>
                  }
                  @case ('dumbbell') {
                    <svg lucideDumbbell [size]="28" [strokeWidth]="1"></svg>
                  }
                  @case ('education') {
                    <svg lucideGraduationCap [size]="28" [strokeWidth]="1"></svg>
                  }
                }
              </span>
...
export class IndustriesSectionComponent implements AfterViewInit, OnDestroy {
  ...
  protected readonly countLabel = computed(() =>
    this.i18n.lang() === 'en' ? 'industries' : 'industrias',
  );
