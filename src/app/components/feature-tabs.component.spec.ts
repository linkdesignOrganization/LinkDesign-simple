...
const tabs: FeatureTab[] = [
  { lead: 'Ordena', body: 'la operación que ya tienes.', videoSrc: '/media/a.mp4', poster: '/media/a.jpg' },
  { lead: 'Centraliza', body: 'las fichas y los flujos.', videoSrc: '/media/b.mp4', poster: '/media/b.jpg' },
  { lead: 'Automatiza', body: 'las tareas repetitivas.', videoSrc: '/media/c.mp4', poster: '/media/c.jpg' }
];
