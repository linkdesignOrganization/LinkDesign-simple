...
const webPageEs: LandingData = {
  ...
  portfolio: {
    rows: [
      { client: 'Tornos del Sur', industry: 'Metalúrgica', projectType: 'Sistema interno + reportes', link: '#', videoSrc: '/media/software-demo.mp4', poster: '/media/software-demo-poster.jpg' },
      { client: 'Frigorífico Las Pampas', industry: 'Frigorífico', projectType: 'Sistema interno + multi sede', link: '#', videoSrc: '/media/software-demo.mp4', poster: '/media/software-demo-poster.jpg' },
      { client: 'Constructora Andina', industry: 'Construcción', projectType: 'Corporativo + portal de clientes', link: '#', videoSrc: '/media/software-demo.mp4', poster: '/media/software-demo-poster.jpg' },
      { client: 'Distribuidora Vélez', industry: 'Distribución mayorista', projectType: 'E-commerce + B2B', link: '#', videoSrc: '/media/software-demo.mp4', poster: '/media/software-demo-poster.jpg' },
      { client: 'Estudio Bertolino', industry: 'Estudio jurídico', projectType: 'Corporativo', link: '#', videoSrc: '/media/software-demo.mp4', poster: '/media/software-demo-poster.jpg' },
      { client: 'Bodega Río Negro', industry: 'Vitivinícola', projectType: 'E-commerce + integraciones', link: '#', videoSrc: '/media/software-demo.mp4', poster: '/media/software-demo-poster.jpg' },
      { client: 'Acopio del Este', industry: 'Agroindustria', projectType: 'Sistema interno + multi sede', link: '#', videoSrc: '/media/software-demo.mp4', poster: '/media/software-demo-poster.jpg' },
      { client: 'Textil Garmendia', industry: 'Textil', projectType: 'Sistema interno + reportes', link: '#', videoSrc: '/media/software-demo.mp4', poster: '/media/software-demo-poster.jpg' },
      { client: 'Transportes del Plata', industry: 'Transporte de carga', projectType: 'Corporativo + portal de clientes', link: '#', videoSrc: '/media/software-demo.mp4', poster: '/media/software-demo-poster.jpg' },
      { client: 'Clínica Mendieta', industry: 'Salud', projectType: 'Corporativo + reservas', link: '#', videoSrc: '/media/software-demo.mp4', poster: '/media/software-demo-poster.jpg' }
    ]
  },
  webProcess: {
    title: 'Así trabajamos un proyecto.',
...
const webPageEn: LandingData = {
  ...
  portfolio: {
    rows: [
      { client: 'Tornos del Sur', industry: 'Metalworking', projectType: 'Internal system + reports', link: '#', videoSrc: '/media/software-demo.mp4', poster: '/media/software-demo-poster.jpg' },
      { client: 'Frigorífico Las Pampas', industry: 'Meat packing', projectType: 'Internal system + multi-site', link: '#', videoSrc: '/media/software-demo.mp4', poster: '/media/software-demo-poster.jpg' },
      { client: 'Constructora Andina', industry: 'Construction', projectType: 'Corporate + client portal', link: '#', videoSrc: '/media/software-demo.mp4', poster: '/media/software-demo-poster.jpg' },
      { client: 'Distribuidora Vélez', industry: 'Wholesale distribution', projectType: 'E-commerce + B2B', link: '#', videoSrc: '/media/software-demo.mp4', poster: '/media/software-demo-poster.jpg' },
      { client: 'Estudio Bertolino', industry: 'Law firm', projectType: 'Corporate', link: '#', videoSrc: '/media/software-demo.mp4', poster: '/media/software-demo-poster.jpg' },
      { client: 'Bodega Río Negro', industry: 'Winery', projectType: 'E-commerce + integrations', link: '#', videoSrc: '/media/software-demo.mp4', poster: '/media/software-demo-poster.jpg' },
      { client: 'Acopio del Este', industry: 'Agribusiness', projectType: 'Internal system + multi-site', link: '#', videoSrc: '/media/software-demo.mp4', poster: '/media/software-demo-poster.jpg' },
      { client: 'Textil Garmendia', industry: 'Textile', projectType: 'Internal system + reports', link: '#', videoSrc: '/media/software-demo.mp4', poster: '/media/software-demo-poster.jpg' },
      { client: 'Transportes del Plata', industry: 'Freight transport', projectType: 'Corporate + client portal', link: '#', videoSrc: '/media/software-demo.mp4', poster: '/media/software-demo-poster.jpg' },
      { client: 'Clínica Mendieta', industry: 'Healthcare', projectType: 'Corporate + booking', link: '#', videoSrc: '/media/software-demo.mp4', poster: '/media/software-demo-poster.jpg' }
    ]
  },
  webProcess: {
    title: 'How we run a project.',
