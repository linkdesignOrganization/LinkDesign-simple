...
const webPageEs: LandingData = {
  ...
  portfolio: {
    rows: [
      ...
      // Oculto temporalmente (Facio & Cañas) — descomentar para volver a mostrarlo:
      ...
      // Oculto temporalmente en LinkDesign (NO borrar; sigue visible en Nolo). Reactivar quitando el //.
      ...
      { client: 'R. Loría', industry: 'Legal', projectType: 'Corporativo', link: 'https://legalwaycr.com/', videoSrc: '/media/portfolio/legalway.mp4', logo: '/media/portfolio/logos/legalway.svg', poster: '/media/portfolio/legalway.jpg' },
...
const webPageEn: LandingData = {
  ...
  portfolio: {
    rows: [
      ...
      { client: 'R. Loría', industry: 'Legal', projectType: 'Corporate', link: 'https://legalwaycr.com/', videoSrc: '/media/portfolio/legalway.mp4', logo: '/media/portfolio/logos/legalway.svg', poster: '/media/portfolio/legalway.jpg' },
