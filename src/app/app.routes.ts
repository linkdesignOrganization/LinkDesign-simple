...
// Portafolio generado por el prebuild (scripts/generate-portfolio.mjs) desde el CRM — ver §portfolio.
...
const softwarePageEs: LandingData = {
  ...
  viewcases: {
    ...
    items: [
      { label: 'Pulso', detail: '/desarrollo-de-software-costa-rica/pulso', category: 'Sistema de gestión para gimnasios y wellness', videoSrc: '/media/software/pulso.mp4', videoMobileSrc: '/media/software/pulso-mobile.mp4', poster: '/media/software/pulso.jpg', link: 'https://jolly-stone-0869f530f.7.azurestaticapps.net' },
      { label: 'Cumbre', detail: '/desarrollo-de-software-costa-rica/cumbre', category: 'Sistema de gestión de recursos humanos', videoSrc: '/media/software/cumbre.mp4', videoMobileSrc: '/media/software/cumbre-mobile.mp4', poster: '/media/software/cumbre.jpg', link: 'https://orange-forest-0713c560f.7.azurestaticapps.net' },
      { label: 'Estudio Dental Mendieta', detail: '/desarrollo-de-software-costa-rica/estudio-dental-mendieta', category: 'Software de gestión clínica', videoSrc: '/media/software/dental.mp4', videoMobileSrc: '/media/software/dental-mobile.mp4', poster: '/media/software/dental.jpg', link: 'https://happy-coast-044ea7e0f.7.azurestaticapps.net/agenda' },
      { label: 'Tornos del Sur', detail: '/desarrollo-de-software-costa-rica/tornos-del-sur', category: 'ERP industrial', videoSrc: '/media/software/tornos.mp4', videoMobileSrc: '/media/software/tornos-mobile.mp4', poster: '/media/software/tornos.jpg', link: 'https://app-tornosops.azurewebsites.net/dashboard' },
      { label: 'Punto Cero', detail: '/desarrollo-de-software-costa-rica/punto-cero', category: 'Sistema de mantenimiento por suscripción', videoSrc: '/media/software/puntocero.mp4', videoMobileSrc: '/media/software/puntocero-mobile.mp4', poster: '/media/software/puntocero.jpg', link: 'https://victorious-desert-032f8750f.1.azurestaticapps.net/acceso' },
      { label: 'Vértice Seguridad Industrial', detail: '/desarrollo-de-software-costa-rica/vertice-seguridad-industrial', category: 'ERP comercial y de inventario', videoSrc: '/media/software/vertice.mp4', videoMobileSrc: '/media/software/vertice-mobile.mp4', poster: '/media/software/vertice.jpg', link: 'https://icy-meadow-07f007e0f.6.azurestaticapps.net/dashboard/home' }
    ]
  },
  faq: {
...
const softwarePageEn: LandingData = {
  ...
  viewcases: {
    ...
    items: [
      { label: 'Pulso', detail: '/desarrollo-de-software-costa-rica/pulso', category: 'Gym & wellness management system', videoSrc: '/media/software/pulso.mp4', videoMobileSrc: '/media/software/pulso-mobile.mp4', poster: '/media/software/pulso.jpg', link: 'https://jolly-stone-0869f530f.7.azurestaticapps.net' },
      { label: 'Cumbre', detail: '/desarrollo-de-software-costa-rica/cumbre', category: 'HR management system', videoSrc: '/media/software/cumbre.mp4', videoMobileSrc: '/media/software/cumbre-mobile.mp4', poster: '/media/software/cumbre.jpg', link: 'https://orange-forest-0713c560f.7.azurestaticapps.net' },
      { label: 'Estudio Dental Mendieta', detail: '/desarrollo-de-software-costa-rica/estudio-dental-mendieta', category: 'Clinic management software', videoSrc: '/media/software/dental.mp4', videoMobileSrc: '/media/software/dental-mobile.mp4', poster: '/media/software/dental.jpg', link: 'https://happy-coast-044ea7e0f.7.azurestaticapps.net/agenda' },
      { label: 'Tornos del Sur', detail: '/desarrollo-de-software-costa-rica/tornos-del-sur', category: 'Industrial ERP', videoSrc: '/media/software/tornos.mp4', videoMobileSrc: '/media/software/tornos-mobile.mp4', poster: '/media/software/tornos.jpg', link: 'https://app-tornosops.azurewebsites.net/dashboard' },
      { label: 'Punto Cero', detail: '/desarrollo-de-software-costa-rica/punto-cero', category: 'Subscription-based maintenance system', videoSrc: '/media/software/puntocero.mp4', videoMobileSrc: '/media/software/puntocero-mobile.mp4', poster: '/media/software/puntocero.jpg', link: 'https://victorious-desert-032f8750f.1.azurestaticapps.net/acceso' },
      { label: 'Vértice Seguridad Industrial', detail: '/desarrollo-de-software-costa-rica/vertice-seguridad-industrial', category: 'Commercial & inventory ERP', videoSrc: '/media/software/vertice.mp4', videoMobileSrc: '/media/software/vertice-mobile.mp4', poster: '/media/software/vertice.jpg', link: 'https://icy-meadow-07f007e0f.6.azurestaticapps.net/dashboard/home' }
    ]
  },
  faq: {
...
const webPageEs: LandingData = {
  ...
  portfolio: {
    // Filas generadas por el prebuild (scripts/generate-portfolio.mjs) desde el CRM
    // (GET /api/public/portfolio?site=CR). Alta, edición, orden y visibilidad por sitio
    // se administran en el CRM — acá NO se edita a mano; el JSON commiteado es el fallback
    // si el CRM no responde durante el build.
...
const webPageEn: LandingData = {
  ...
  portfolio: {
    // Generado por el prebuild desde el CRM (ver webPageEs.portfolio): mismas filas, textos EN.
