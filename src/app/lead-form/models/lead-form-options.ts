...
export const LANDING_BY_PATH_SEGMENT: Readonly<Record<string, SourceLanding>> = {
  software: 'software',
  // El hub de software de Costa Rica y sus fichas de demo son la misma oferta
  // que `/software`, con otra puerta de entrada (búsqueda local). Hasta el
  // 2026-09-08 caían en el cajón por defecto y cobraban cinco puntos en lugar
  // de diez.
  'desarrollo-de-software-costa-rica': 'software',
 ...
 * ("Contacto Formulario"), separada de los clicks de WhatsApp, correo y
 * agendar. Antes las cuatro compartían el send_to de "Contacto", y esa mezcla
 * escondió durante semanas que la campaña "Búsqueda" había dejado de traer
 * formularios: en los informes seguía viéndose "contactos" sin más.
 * Ver docs/bitacora-ads-values-troas.md.
 */
export const GA_CONVERSION = {
  /** "Contacto Formulario" en Ads — el mismo label que ADS_CONVERSIONS.CONTACTO_FORMULARIO. */
  SEND_TO: 'AW-16767245191/VGKrCL6XquEcEIe3n7s-',
  CURRENCY: 'USD',
