...
export type IndustryDetail = {
  ...
  /** 04 — Lo que tú pones / lo que ponemos nosotros. */
...
export const INDUSTRIES_CONTENT: Record<IndustrySlug, { es: IndustryDetail; en: IndustryDetail }> =
  {
    ...
    'industria-y-produccion': {
      es: {
        ...
        talk: {
          ...
          text: 'Si te interesa explorar qué solución a medida tendría sentido para tu operación, conversemos. La primera charla es para entender cómo produces hoy, qué te ayuda a estar ordenado y qué te complica. No vendemos paquetes cerrados.',
        },
      },
      en: {
        slug: 'industria-y-produccion',
    ...
    'distribucion-y-logistica': {
      es: {
        ...
        roles: {
          yours:
            'El conocimiento de cómo se mueve la mercadería en tu empresa. Qué vendes o transportas, para qué clientes, en qué tiempos, desde qué depósitos o puertos. Los acuerdos comerciales, los márgenes y los plazos de pago con cada cliente. Las decisiones operativas y de prioridad que solo tú puedes tomar.',
          ours: 'La metodología para escuchar y entender tu operación en profundidad. La arquitectura técnica del sistema. El desarrollo del software, del sitio web, del portal de clientes o de lo que la solución necesite incluir. El acompañamiento durante la implementación y el soporte después.',
        },
        couldBuild: {
          intro:
    ...
    'salud-y-bienestar': {
      es: {
        ...
        whatWeDo: [
          'Convertimos la operación que ya está pasando en tu centro o consultorio en un sistema digital que la ordene. Tomamos los turnos que se anotan en cuadernos o en hojas de cálculo, las historias que viven en Word o en papel, las hojas de cálculo de coberturas, los mensajes con pacientes y todo lo demás que tu equipo gestiona a mano, y lo transformamos en algo que el día a día pueda registrar, seguir, controlar y consultar desde un solo lugar.',
          'Esto no cambia cómo atiendes. Cambia cómo se ve y se administra todo lo que pasa antes y después de la consulta o de la atención, para que la información de tu centro trabaje a favor del equipo en lugar de complicarlo.',
          'Da igual si eres un consultorio individual, una clínica con varios profesionales o un centro con varias sedes. Lo que diseñamos se adapta al tamaño y al modo de trabajo de tu operación. No te vendemos sistemas hospitalarios con cien módulos que nunca vas a usar. Te construimos exactamente la solución que tu centro necesita ahora, con margen para crecer cuando crezcas.',
        ],
        inTheSector: {
          paragraphs: [
          ...
          disclaimer:
            'Y acá te lo aclaramos directo: no somos médicos, ni odontólogos, ni kinesiólogos, ni veterinarios. No hacemos diagnósticos, no entendemos los protocolos específicos de tu disciplina ni vamos a pretender opinar sobre cómo atiendes. Eso es lo tuyo y lo respetamos. Lo que sí hacemos es escuchar cómo funciona tu centro en concreto y traducir esa operación en software que la haga más simple de gestionar.',
        },
        roles: {
          yours:
            'El conocimiento de cómo se atiende en tu centro. Quiénes son tus profesionales, qué especialidades o servicios brindas, qué tipo de pacientes o clientes recibes, qué coberturas aceptas, cómo se organiza la agenda y qué hace al día a día más complicado de lo necesario. Las decisiones clínicas y operativas que solo tú puedes tomar.',
        ...
        couldBuild: {
          ...
          items: [
            ...
            {
              kind: 'web',
              text: 'Un sitio web institucional que comunique con claridad qué especialidades o servicios atiendes, qué coberturas aceptas y cómo se sacan turnos, con formularios que entren directo a la agenda.',
            },
            {
              kind: 'portal',
    ...
    'servicios-profesionales': {
      es: {
        ...
        whatWeDo: [
          ...
          'Esto no cambia cómo trabajas con tus clientes. Cambia cómo se ve y se administra todo lo que pasa alrededor: el registro de tiempos, el avance de proyectos, la comunicación con clientes, los cobros y la rentabilidad real de cada trabajo. Para que el conocimiento que hoy depende de algunas personas clave quede sostenido por el sistema.',
          'Da igual si eres un estudio chico de dos o tres profesionales, una firma mediana con varios socios y equipo, o una empresa con clientes en distintas industrias. Lo que diseñamos se adapta al tamaño y al modo de trabajo de tu organización. No te vendemos sistemas corporativos con módulos que nunca vas a usar. Te construimos exactamente la solución que tu estudio o empresa necesita ahora, con margen para crecer cuando crezcas.',
        ],
        inTheSector: {
          paragraphs: [
          ...
          disclaimer:
            'Y acá te lo aclaramos directo: no somos abogados, ni contadores, ni consultores. No conocemos los detalles técnicos de tu profesión ni vamos a opinar sobre cómo haces tu trabajo. Eso es lo tuyo y lo respetamos. Lo que sí hacemos es escuchar cómo funciona tu estudio o empresa en concreto y traducir esa operación en software que la haga más simple de gestionar.',
        },
        roles: {
          yours:
            'El conocimiento de cómo trabaja tu estudio o empresa. Qué tipo de clientes manejas, qué tipo de proyectos o casos llevas adelante, cómo cobras (por horas, por hito, por proyecto o por retainer), qué hace a tu equipo distinto en el mercado. Las decisiones operativas y comerciales que solo tú puedes tomar.',
          ours: 'La metodología para escuchar y entender tu operación en profundidad. La arquitectura técnica del sistema. El desarrollo del software, del sitio web, del portal de clientes o de lo que la solución necesite incluir. El acompañamiento durante la implementación y el soporte después.',
        },
        couldBuild: {
          intro:
    ...
    'servicios-tecnicos': {
      es: {
        ...
        whatWeDo: [
          ...
          'Esto no cambia cómo prestas el servicio. Cambia cómo se ve y se administra todo lo que pasa alrededor: la planificación de visitas, la coordinación con técnicos, el control de contratos, la facturación recurrente y la comunicación con tus clientes. Para que el dato trabaje a tu favor en lugar de demandarte el tiempo del equipo administrativo para perseguirlo.',
          'Da igual si tienes un par de técnicos haciendo visitas, un equipo mediano con varios contratos vigentes o una empresa con servicio en distintas zonas. Lo que diseñamos se adapta al tamaño y al modo de trabajo de tu operación. No te vendemos sistemas de gestión gigantes con módulos que nunca vas a usar. Te construimos exactamente la solución que tu empresa necesita ahora, con margen para crecer cuando crezcas.',
        ],
        inTheSector: {
          paragraphs: [
        ...
        roles: {
          yours:
            'El conocimiento de cómo opera tu empresa. Qué servicios prestas, a qué tipo de clientes, con qué técnicos, en qué zonas, qué contratos manejas y qué SLA tienes que cumplir. Las decisiones operativas y comerciales que solo tú puedes tomar.',
          ours: 'La metodología para escuchar y entender tu operación en profundidad. La arquitectura técnica del sistema. El desarrollo del software, del sitio web, del portal de clientes o de lo que la solución necesite incluir. El acompañamiento durante la implementación y el soporte después.',
        },
        couldBuild: {
          intro:
    ...
    'fitness-y-wellness': {
      es: {
        ...
        whatWeDo: [
          ...
          'Esto no cambia cómo entrenas, atiendes o brindas el servicio. Cambia cómo se ve y se administra todo lo que pasa alrededor: la gestión de socios, los cobros recurrentes, la asistencia, la agenda de clases, los profesionales y la comunicación con tu cartera. Para que la información trabaje a favor del equipo en lugar de complicarle el día.',
          'Da igual si tienes un estudio chico con una sola sala, un gimnasio mediano con varios entrenadores, una cadena con varias sedes o un centro de estética con cabinas independientes. Lo que diseñamos se adapta al tamaño y al modo de trabajo de tu operación. No te vendemos sistemas con cientos de funcionalidades que nunca vas a usar. Te construimos exactamente la solución que tu centro necesita ahora, con margen para crecer cuando crezcas.',
        ],
        inTheSector: {
          paragraphs: [
            'Cuando hablamos con gente que dirige un gimnasio, un estudio de yoga, un centro wellness o un local de estética escuchamos cosas que se repiten. Reservas que entran por tres o cuatro canales distintos sin centralización. Cobros mensuales que se hacen a mano cliente por cliente. Socios que dejan de venir sin que nadie se entere a tiempo. Asistencia que se anota en hoja de cálculo y nunca se cruza con el cobro. Comunicación con la cartera que depende de quien tenga el WhatsApp del centro abierto ese día.',
          ...
          disclaimer:
            'Y acá te lo aclaramos directo: no somos entrenadores, ni profesores de yoga, ni esteticistas. No diseñamos rutinas, no damos clases ni vamos a opinar sobre cómo entrenas o cómo atiendes. Eso es lo tuyo y lo respetamos. Lo que sí hacemos es escuchar cómo funciona tu centro en concreto y traducir esa operación en software que la haga más simple de gestionar.',
        },
        roles: {
          yours:
            'El conocimiento de cómo opera tu centro. Qué tipo de socios o clientes tienes, qué planes ofreces, qué clases o servicios brindas, cómo se organiza la agenda y qué hace que tu lugar sea distinto a los demás. Las decisiones operativas y comerciales que solo tú puedes tomar.',
        ...
        couldBuild: {
          ...
          items: [
            ...
            {
              kind: 'web',
              text: 'Un sitio web institucional que comunique con claridad qué clases o servicios ofreces, qué planes tienes disponibles, dónde están tus sedes y cómo sumarse, con formularios de inscripción que entren directo al sistema interno.',
            },
          ],
          closing:
            'Todas estas piezas pueden formar parte de una misma solución integral. No separamos software por un lado y sitio web por el otro. Diseñamos la solución completa, en bloques que se complementan según lo que tu centro necesita.',
    ...
    'educacion-y-formacion': {
      es: {
        ...
        inTheSector: {
          ...
          disclaimer:
            'Y acá te lo aclaramos directo: no somos docentes, ni pedagogos, ni especialistas en formación. No diseñamos planes de estudio, no damos clases ni vamos a opinar sobre cómo enseñas. Eso es lo tuyo y lo respetamos. Lo que sí hacemos es escuchar cómo funciona tu institución en concreto y traducir esa operación en software que la haga más simple de gestionar.',
        },
        roles: {
          yours:
            'El conocimiento de cómo opera tu institución. Qué cursos o programas ofreces, cómo se organizan las cohortes, qué profesores tienes, cómo cobras (cuotas, matrículas, paquetes), qué tipo de alumnos recibes y qué hace que tu propuesta sea distinta. Las decisiones académicas y operativas que solo tú puedes tomar.',
