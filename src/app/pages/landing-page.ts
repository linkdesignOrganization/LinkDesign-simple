...
@Component({
    ...
    >
      @if (page().isHome) {
        ...
        <section
          ...
          aria-label="Link Design services"
        >
        ...
        @if (!page().webHero) {
          ...
          >
            <div class="hero-title">
              ...
              <h1>{{ titleHead() }}<span class="hero-title__tail">{{ titleTail() }}<img class="hero-flag" src="/flag.svg" alt="Costa Rica" /></span></h1>
            </div>
  ...
  styles: `
    ...
    /* Bandera de Costa Rica al final del título, como parte del texto (refuerza el origen CR). */
    .hero-title__tail {
      white-space: nowrap;
    }
...
export class LandingPageComponent {
  ...
  //   ''                              → proyecto sin video (ej. Asembis): slide de solo póster,
  //     deliberado
