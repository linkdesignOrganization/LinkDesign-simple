...
const INDEX_TEXT = {
  es: {
    ...
    lead: 'No construimos lo mismo para todos. Mira cómo ordenamos la operación en tu sector, con software y sitios web hechos a tu medida.',
    sectionHeading: 'Elige tu sector',
    sectionIntro:
      'Cada operación es distinta. Estas son las industrias en las que más trabajamos; entra a la tuya para ver qué podríamos construir.',
  },
  en: {
    eyebrow: 'Industries',
