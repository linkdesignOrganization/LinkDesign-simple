...
import { SoftwareCrCasePageComponent } from './software-cr-case-page';
...
describe('SoftwareCrCasePageComponent · botón de agendar', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [SoftwareCrCasePageComponent],
      providers: [
        provideRouter([]),
  ...
  function render(lang: 'es' | 'en') {
    ...
    const fixture = TestBed.createComponent(SoftwareCrCasePageComponent);
