...
// ─────────────────────────────────────────────────────────────────────────────
// Contenido de las páginas de detalle de cada sistema de software (Link Design).
// Adaptado del contenido aprobado de Sowe: MISMA información, voz en español
// neutro (tú) y regionalismos ajustados a Costa Rica (hoja de cálculo, vitrina,
// anticipo). No editar el copy "a ojo"; está aprobado.
//
...
export type SystemDetail = {
  ...
  /** 08 — Verlo funcionando (3 párrafos; el último cierra con el CTA "escríbenos"). */
...
export const SYSTEMS_CONTENT: Record<SystemSlug, { es: SystemDetail; en: SystemDetail }> = {
  ...
  'crm-a-medida': {
    es: {
      ...
      problem: [
        'El equipo comercial trabaja con la información dispersa. Los mensajes están en WhatsApp, los correos en otra parte, las llamadas sin registrar y el seguimiento en una hoja de cálculo que cada uno completa a su manera.',
      ...
      whenItFits: {
        ...
        notYet:
          'Si vendes con un formulario simple y sin seguimiento posterior, probablemente todavía no lo necesites.'
      },
      doFeatures: [
        {
        ...
        },
        {
          ...
          benefit: 'Sabes en qué punto está cada negocio sin tener que preguntar.'
        },
        {
        ...
        {
          action: 'Arma cotizaciones según los criterios comerciales que defines, no con plantillas fijas.',
          benefit: ''
        },
        {
      ...
      connects: [
        ...
        'Si usas otros sistemas internos, la integración se evalúa caso por caso. Lo que es estándar entra en el desarrollo. Conectar un sistema externo se define y se cotiza como módulo aparte.'
      ],
      notWhat: [
      ...
      howWeBuild: [
        ...
        'Se construye por módulos. Puedes empezar por el núcleo y sumar el resto después, sin rehacer lo anterior.',
      ...
      faq: [
        {
          ...
          answer:
            'Sí. Si hoy usas otra herramienta o una hoja de cálculo, revisamos cómo están estructurados esos datos y los migramos al sistema nuevo. El alcance de la migración se define en el discovery, porque depende de qué tan ordenados estén hoy.'
        },
        {
          question: '¿Cuánto tarda en estar funcionando?',
          answer:
            'Depende del alcance, que se cierra en el discovery. Como trabajamos por módulos y entregas por etapas, empiezas a usar el núcleo del sistema antes de que esté completo el total.'
        },
        {
  ...
  'erp-operacion-inventario': {
    es: {
      ...
      problem: [
        'El stock se controla con hojas de cálculo que se actualizan tarde y no siempre coinciden con lo que hay en el depósito. Cuando hay varias sucursales, cada una lleva su propio registro y nadie ve el total.',
      ...
      whenItFits: {
        fits: [
          'Tiene sentido cuando manejas stock en más de un depósito o sucursal y necesitas ver el total sin sumar hojas de cálculo a mano.',
          'También cuando la mercadería se mueve entre puntos y pierdes el rastro de qué hay, dónde y desde cuándo.'
        ],
        notYet: 'Si tienes un solo punto y bajo volumen, una hoja de cálculo todavía puede alcanzarte.'
      },
      doFeatures: [
        {
      ...
      howWeBuild: [
        ...
        'Se construye por módulos. Puedes empezar por el control de stock y sumar despacho, transferencias o reportes después, sin rehacer lo anterior.',
        'La tecnología puntual se decide en la etapa de discovery, según lo que tu operación necesita. No partimos de una herramienta fija a la que después haya que amoldarse.'
      ],
      seeItWork: SEE_IT_WORK_ES,
      faq: [
        {
          ...
          answer:
            'Sí. Si hoy llevas el stock en hojas de cálculo o en otra herramienta, revisamos cómo están estructurados esos datos y los cargamos al sistema nuevo. El alcance de la migración se define en el discovery, porque depende de qué tan ordenados estén hoy.'
        },
        {
  ...
  'ecommerce-logica-propia': {
    es: {
      ...
      whenItFits: {
        fits: [
          'Tiene sentido cuando tu forma de vender no entra en una tienda estándar: manejas distintos tipos de cliente, listas de precio o condiciones que cambian según quién compra.',
          'También cuando ya tienes una tienda en una plataforma cerrada y chocaste con su límite, donde lo que necesitas no se puede hacer sin forzar la herramienta.'
        ],
        notYet:
          'Si vendes pocos productos con un precio único para todos, una plataforma estándar probablemente te alcance.'
      },
      doFeatures: [
        {
        ...
        {
          action: 'Integra los medios de pago que ya usas.',
      ...
      connects: [
        'Se conecta con tu inventario para mantener el stock sincronizado, y con los medios de pago que ya usas para cobrar.',
        'Si usas otros sistemas internos, la integración se evalúa caso por caso. Lo que es estándar entra en el desarrollo. Conectar un sistema externo se define y se cotiza como módulo aparte.'
      ],
      notWhat: [
        ...
        'Tampoco es solo una vitrina de productos. Es la lógica comercial de tu negocio funcionando en línea.'
      ],
      howWeBuild: [
        ...
        'Se construye por módulos. Puedes empezar por el catálogo y el carrito, y sumar reglas, integraciones o panel después, sin rehacer lo anterior.',
  ...
  'ticketing-marca-propia': {
    es: {
      ...
      whatItIs:
        'Un sistema de ticketing con marca propia es una plataforma de venta de entradas que opera bajo tu marca, no bajo la de una ticketera externa. El público compra desde tu sitio oficial, recibe su entrada con código QR y entra al evento dentro del mismo flujo.\n\nEl sistema tiene dos partes: un panel donde configuras y gestionas las entradas, y una aplicación propia con la que tu equipo lee los QR en el acceso. Las dos se entregan como parte del desarrollo.',
      problem: [
        'Cuando vendes entradas a través de una ticketera externa, la venta pasa por su marca y su plataforma. Los datos de quién compró quedan del lado de un tercero, y por cada entrada vendida la ticketera se lleva una comisión.',
        'Con marca propia, la venta ocurre en tu sitio. Tienes los datos de tu público, el control del evento no depende de una plataforma ajena y te ahorras la comisión que la ticketera cobra en cada venta.'
      ],
      whenItFits: {
        fits: [
          'Tiene sentido para artistas, productoras y espacios que organizan eventos con frecuencia y quieren dejar de depender de una ticketera externa.',
        ...
        notYet: 'Si organizas un evento aislado y puntual, una ticketera externa puede resolverte ese caso.'
      },
      doFeatures: [
        {
        ...
        },
        {
          ...
          benefit: 'Defines las categorías según lo que vendes cada vez.'
        },
        {
        ...
        },
        {
          ...
          benefit: 'Ves cómo va cada evento sin cruzar hojas de cálculo.'
        }
      ],
      connects: [
        'Se conecta con los medios de pago que ya usas, para que el cobro de las entradas ocurra en tu sitio y no en una ticketera externa.',
        'Si usas otros sistemas, como tu CRM o tus herramientas de difusión, la integración se evalúa caso por caso. Lo que es estándar entra en el desarrollo. Conectar un sistema externo se define y se cotiza como módulo aparte.'
      ],
      notWhat: [
        'No es una cuenta dentro de una ticketera donde publicas tu evento bajo la marca de otro. Es tu propia plataforma, con tus datos y tu público.',
      ...
      howWeBuild: [
        'Primero definimos el sistema, después escribimos código. Mapeamos cómo vendes, qué tipos de entrada manejas y cómo controlas el ingreso, antes de programar nada.',
        'Se construye por módulos. Puedes empezar por la venta y el QR, y sumar la aplicación de acceso, reportes o integraciones después, sin rehacer lo anterior.',
        'La tecnología puntual se decide en la etapa de discovery, según lo que tu operación necesita. No partimos de una plataforma fija a la que después haya que amoldarse.'
      ],
      seeItWork: SEE_IT_WORK_ES,
      faq: [
    ...
    es: {
      ...
      whenItFits: {
        fits: [
          ...
          'También cuando tienes varias personas, salas o recursos que reservar a la vez, y coordinar la disponibilidad entre todos se volvió difícil.'
        ],
        notYet: 'Si atiendes pocos turnos y los manejas sin problema, todavía no hace falta.'
      },
      doFeatures: [
        {
        ...
        },
        {
          ...
          benefit: 'Sabes quién viene, a qué y cuántas veces ya vino.'
        },
        {
          action: 'Permite cobrar la reserva o un anticipo en línea, si tu operación lo necesita.',
          benefit: 'Asegura el turno y reduce las ausencias.'
        }
      ],
      connects: [
        'Se conecta con tu calendario y con los medios de pago que ya usas, cuando la reserva incluye un cobro.',
        'Si usas otros sistemas internos, como tu CRM o tu sistema de gestión, la integración se evalúa caso por caso. Lo que es estándar entra en el desarrollo. Conectar un sistema externo se define y se cotiza como módulo aparte.'
      ],
      notWhat: [
      ...
      howWeBuild: [
        ...
        'Se construye por módulos. Puedes empezar por la agenda y las reservas, y sumar recordatorios, pagos o integraciones después, sin rehacer lo anterior.',
        'La tecnología puntual se decide en la etapa de discovery, según lo que tu operación necesita. No partimos de una herramienta fija a la que después haya que amoldarse.'
      ],
      seeItWork: SEE_IT_WORK_ES,
      faq: [
        ...
        },
        {
          ...
          answer:
            'Sí, si tu operación lo necesita. La reserva puede pedir el pago o un anticipo en línea para confirmar el turno. Si no aplica a tu caso, la reserva funciona sin cobro.'
        }
      ]
    },
    en: {
  ...
  'dashboards-y-reporting': {
    es: {
      ...
      problem: [
        'Los números se arman a fin de mes, en una hoja de cálculo que alguien llena a mano juntando datos de distintos lados. Para cuando el reporte está listo, ya es tarde para usarlo.',
      ...
      whenItFits: {
        fits: [
          'Tiene sentido cuando ya tienes sistemas o datos cargados, pero verlos juntos y al día cuesta trabajo.',
      ...
      doFeatures: [
        ...
        },
        {
          ...
          benefit: 'Se definen contigo, no vienen de una lista genérica.'
        },
        {
          action: 'Genera reportes descargables cuando los necesitas.',
      ...
      notWhat: [
        ...
        'Tampoco es una captura de pantalla ni un PDF que queda viejo apenas se genera. El tablero está vivo: muestra el dato actual cada vez que lo abres.'
      ],
      howWeBuild: [
        'Primero definimos qué decisiones tienes que tomar y qué métricas las respaldan, después construimos el tablero. Así muestra lo que sirve y no lo que sobra.',
        'Se construye por módulos. Puedes empezar por los indicadores principales y sumar vistas, reportes o nuevas fuentes después, sin rehacer lo anterior.',
  ...
  'automatizacion-ia': {
    es: {
      ...
      whenItFits: {
        ...
        notYet:
          'Si lo que quieres automatizar cambia en cada caso y no tiene un patrón, probablemente todavía no sea para automatizar.'
      },
      doFeatures: [
        {
        ...
        {
          action: 'Completa formularios y hojas de cálculo repetitivas.',
        ...
        },
        {
          ...
          benefit: 'Puedes revisar qué procesó y corregir si algo no cuadra.'
        }
      ],
      connects: [
        'Se conecta con los sistemas y los canales por donde hoy entran esas tareas: tus documentos, tus formularios, tu correo o el sistema donde cargas los datos.',
      ...
      howWeBuild: [
        ...
        'Se construye por módulos. Puedes empezar por un solo flujo, medir si rinde, y sumar otros después, sin rehacer lo anterior.',
      ...
      faq: [
        {
          ...
          answer:
            'No, salvo que lo definas para casos muy claros. Por defecto se ocupa de la parte repetitiva y deja la decisión en manos de tu equipo. Dónde interviene y dónde no, se define al armar el flujo.'
        },
        {
        ...
        },
        {
          ...
          answer:
            'Sí. Lo recomendable es arrancar con un flujo concreto, medir si te ahorra tiempo de verdad, y solo entonces sumar otros. No hace falta automatizar todo de entrada.'
        }
      ]
    },
    en: {
