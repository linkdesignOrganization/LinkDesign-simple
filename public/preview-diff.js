...
(function () {
  ...
  var CAMBIOS = [
    ...
    { pag: '/web', de: 'Sitios web hechos en serio.', a: 'Páginas web hechas en serio.' },
    {
      ...
      a: 'Sin plantillas, sin atajos, sin constructores genéricos. Desarrollo web a medida de verdad, en Costa Rica.'
    },
    ...
    {
      pag: '/software',
      de: 'No adaptas tu empresa al software. Construimos el software alrededor de cómo ya funciona tu operación.',
      a: 'No adaptas tu empresa al software. Somos una empresa de desarrollo de software en Costa Rica y lo construimos alrededor de cómo ya funciona tu operación.'
    },
    { pag: '/software', de: 'Así trabajamos un proyecto.', a: 'Así trabajamos un proyecto de desarrollo de software.' },
    {
      pag: '/software',
      de: 'Trabajamos principalmente con Angular para frontend, Node para backend y Azure para infraestructura, base de datos y servicios.',
      a: 'Como empresa de tecnología en Costa Rica, trabajamos principalmente con Angular para frontend, Node para backend y Azure para infraestructura, base de datos y servicios.'
    },
    ...
    { pag: '/en/web', de: 'Real websites. Real code.', a: 'Real web design. Real code.' },
    {
      ...
      a: 'No templates. No shortcuts. No generic builders. Custom web design and development in Costa Rica, every site built from code.'
    },
    ...
    { pag: '/en/software', de: 'Software built around your operation.', a: 'Custom software development around your operation.' },
    {
      ...
      a: "You don't adapt your company to the software. We're a custom software development company in Costa Rica, and we build it around how your operation already works."
    },
    { pag: '/en/software', de: 'How we run a project.', a: 'How we run a software development project.' },
    {
      pag: '/en/software',
      de: 'We work mainly with Angular for the frontend, Node for the backend and Azure for infrastructure, database and services.',
      a: 'As a technology company in Costa Rica, we work mainly with Angular for the frontend, Node for the backend and Azure for infrastructure, database and services.'
    },

    // ── metadatos: no se ven en la página, se listan en el panel ──────────────
    { pag: '/web', meta: 'Título del navegador', de: 'Desarrollo web a medida | Link Design Costa Rica', a: 'Diseño y desarrollo de páginas web | Link Design Costa Rica' },
    { pag: '/web', meta: 'Descripción para buscadores', de: 'Sitios web corporativos, e-commerce y landing pages a medida. Diseño moderno, rendimiento y escalabilidad para empresas en Costa Rica.', a: 'Páginas web corporativas, e-commerce y landing pages a medida. Diseño y desarrollo web con rendimiento y escalabilidad para empresas en Costa Rica.' },
    { pag: '/software', meta: 'Título del navegador', de: 'Software a medida para empresas | Link Design CR', a: 'Desarrollo de software a medida | Link Design Costa Rica' },
    { pag: '/software', meta: 'Descripción para buscadores', de: 'Aplicaciones internas, automatización e integración tecnológica. Creamos software a medida que ordena procesos y mejora la productividad.', a: 'Empresa de desarrollo de software en Costa Rica: aplicaciones internas, automatización e integración tecnológica que ordenan procesos y mejoran la productividad.' },
    { pag: '/en/web', meta: 'Título del navegador', de: 'Custom web development | Link Design Costa Rica', a: 'Web design and development | Link Design Costa Rica' },
    { pag: '/en/software', meta: 'Título del navegador', de: 'Custom software for companies | Link Design CR', a: 'Custom software development | Link Design Costa Rica' }
  ];
