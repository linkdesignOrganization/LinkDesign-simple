...
(function () {
  ...
  var CAMBIOS = [
    ...
    { pag: "/software", de: "Sistemas que construimos a la medida", a: "Desarrollo de software a medida: los sistemas que construimos" },
    { pag: "/software", de: "Cada categoría representa una capacidad real, con sistemas en producción. No vendemos un producto empaquetado.", a: "Cada categoría representa una capacidad real, con software en producción en empresas de Costa Rica. No vendemos un producto empaquetado." },
    { pag: "/software", de: "Construimos software interno para recuperar control operativo. Aplicaciones a medida con datos centralizados, integraciones sin romper la operación existente y trazabilidad clara.", a: "Hacemos desarrollo de software interno para empresas de Costa Rica que necesitan recuperar control operativo. Aplicaciones a medida con datos centralizados, integraciones sin romper la operación existente y trazabilidad clara." },
    ...
    { pag: "/software", de: "Prueba un sistema hecho a medida.", a: "Prueba un software a medida." },
    { pag: "/software", de: "Cada demo es una versión funcional de un sistema a medida, pensada para que recorras la operación completa de una industria distinta. Vas a sentir lo simple y rápido que puede ser un software diseñado específicamente para cómo trabajas.", a: "Cada demo es una versión funcional de un software a medida que construimos en Costa Rica, pensada para que recorras la operación completa de una industria distinta. Vas a sentir lo simple y rápido que puede ser un software diseñado específicamente para cómo trabajas." },
    { pag: "/software", de: "Definimos arquitectura, reglas y estructura desde el inicio. El sistema se construye por módulos, permitiendo crecer, ajustar o integrar nuevas funcionalidades sin tener que rehacer todo.", a: "Como empresa de desarrollo de software, definimos arquitectura, reglas y estructura desde el inicio. El sistema se construye por módulos, permitiendo crecer, ajustar o integrar nuevas funcionalidades sin tener que rehacer todo." },
    { pag: "/software", de: "¿Cómo es el soporte después de entregar el sistema?", a: "¿Cómo es el soporte después de entregar el software?" },
    { pag: "/software", de: "El esquema se define en la primera conversación según el proyecto y lo que mejor encaje a ambas partes. Los modelos más usados son pago 30/70 con anticipo y entrega, pagos por hitos según etapas, pagos mensuales con SLA, o suscripción mensual cuando el cliente prefiere modelo SaaS. Nos adaptamos al esquema, no al revés.", a: "Como empresa de software en Costa Rica, definimos el esquema en la primera conversación, según el proyecto y lo que mejor encaje a ambas partes. Los modelos más usados son pago 30/70 con anticipo y entrega, pagos por hitos según etapas, pagos mensuales con SLA, o suscripción mensual cuando el cliente prefiere modelo SaaS. Nos adaptamos al esquema, no al revés." },
