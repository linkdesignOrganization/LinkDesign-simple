#!/usr/bin/env node
/**
 * Prebuild del portafolio — linkdesign.cr consume el CRM.
 *
 * Genera `src/app/generated/portfolio.data.json` desde el endpoint público del CRM:
 *   GET <CRM>/api/public/portfolio?site=CR
 ...
 *
 * QUÉ HACE:
 *   1. Trae los proyectos visibles del sitio CR, ya ordenados por el CRM (sortOrder).
 ...
 *        · heroSrc = ''        → el proyecto NO tiene ningún video (ej. Asembis):
 *                                slide de solo póster, deliberado
