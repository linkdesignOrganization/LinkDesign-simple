...
metadata: 
  ...
  modified: 2026-08-19T03:34:29.877Z
---
...
- **Acciones de conversión — un canal, una acción desde el 13 ago 2026** (5 vienen del sitio):
  ...
  - **Verificadas el 17 ago 2026**: las ocho miden bien. Registraron Correo CR, Correo AR y WhatsApp AR con el value modulado correcto; Reunión y Formulario siguen sin datos por falta de oportunidad, no por fallo.
  - **Medir no es pujar**, y ahí hubo un falso OK (18 ago 2026): las cuatro de Argentina medían bien pero **no pujaban** — sus campañas usan un objetivo personalizado y nadie las agregó a esa lista. **Costa Rica nunca estuvo afectada**: sus cuatro están en el objetivo «Contacto», que es el que puja. Arreglado el mismo día; el caso argentino se documenta en la bitácora de Kravõnia. Cómo se verifica esto: [[google-ads-objetivos-de-puja]].
...
- **Sitio gemelo Kravõnia (Argentina, ex-Sowe):** misma cuenta de Ads, misma estrategia "Maximizar valor de conversión" y misma modulación de clicks, pero acciones de conversión separadas. También separadas por canal desde el 13 ago 2026: `zxm7CMGXquEc…` WhatsApp, `tU5ZCMSXquEc…` Correo, `GPuTCMeXquEc…` Reunión, `ZAj_CMqXquEc…` Formulario, `P_8YCIf4878c…` Scroll. Las suyas son **DEFAULT/WEBSITE** (no CONTACT), pero **sus campañas NO usan los objetivos de la cuenta**: usan el objetivo personalizado «Contacto Argentina» (`6458009700`), así que lo que puja lo decide esa lista de acciones y no la categoría. Cualquier acción nueva para Argentina hay que **agregarla al objetivo a mano** o no puja. Ver [[google-ads-objetivos-de-puja]] y [[sitios-gemelos-linkdesign-kravonia]].
